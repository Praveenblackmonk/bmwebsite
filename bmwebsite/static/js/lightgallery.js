    ...
    $.fn.lightGallery = function (options) {
        ...
        var setUp = {
            ...
            loadContent: function (index) {
                ...
                if (!$this.isVideo(src)) {
                    $slide.eq(index).prepend('<div class="img-cont"><img src="' + src + '" /></div>');
                    ob = $('img');
                } else {
                ...
                if ($children.length > 1) {
                    $slide.eq(index).find(ob).on('load error', function () {
                        for (i = 0; i <= index - 1; i++) {
                            ...
                            if (!$this.isVideo(src)) {
                                $slide.eq(index - i - 1).prepend('<div class="img-cont"><img src="' + src + '" /></div>');
                            } else {
                        ...
                        for (j = 1; j < l; j++) {
                            ...
                            if (!$this.isVideo(src)) {
                                $slide.eq(index + j).prepend('<div class="img-cont"><img src="' + src + '" /></div>');
                            } else {
