...
(function( $ ){ 
	var methods = {
		...
		imageWidget: function(){
				...
				for (var i = 0, f; f = files[i]; i++) {
					...
					reader.onload = (function(imageFile){
						return function(e){
							...
							li.append(a, [$removeDiv]).appendTo($('#imageList'));
						}
					})(f);
			...
			var imageListContainer = $("<div/>",{'class': ''});
			var imageList = $('<ul/>',{"class":"thumbnails padding-top list-unstyled clearfix row mRt30",
										"id": 'imageList'
